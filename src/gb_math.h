...
GB_MATH_DEF float gb_angle_wrap180(float radians);
...
GB_MATH_DEF gbVec3 gb_vec3_muli(gbVec3 v0, float s);
GB_MATH_DEF gbVec3 gb_vec3_subi(gbVec3 v0, gbVec3 v1);
GB_MATH_DEF gbVec3 gb_vec3_addi(gbVec3 v0, gbVec3 v1);

gbVec2 gb_vec2_muli(gbVec2 v0, float s);
gbVec2 gb_vec2_subi(gbVec2 v0, gbVec2 v1);
gbVec2 gb_vec2_addi(gbVec2 v0, gbVec2 v1);
...
GB_MATH_DEF float gb_vec2_cross(gbVec2 v0, gbVec2 v1);
...
GB_MATH_DEF gbVec3 gb_vec3_normi(gbVec3 v);
...
GB_MATH_DEF gbRect2 gb_rect2wh(float x, float y, float w, float h);
...
float gb_angle_wrap180(float radians) {
	radians = fmodf(radians, GB_MATH_TAU);
	return radians > GB_MATH_PI ? radians - GB_MATH_TAU : radians;
}
...
gbVec3 gb_vec3_addi(gbVec3 v0, gbVec3 v1) { gbVec3 r = { 0 }; gb_vec3_add(&r, v0, v1); return r; }
gbVec3 gb_vec3_subi(gbVec3 v0, gbVec3 v1) { gbVec3 r = { 0 }; gb_vec3_sub(&r, v0, v1); return r; }
gbVec3 gb_vec3_muli(gbVec3 v0, float s) { gbVec3 r = { 0 }; gb_vec3_mul(&r, v0, s); return r; }

gbVec2 gb_vec2_addi(gbVec2 v0, gbVec2 v1) { return (gbVec2) { .x = v0.x + v1.x, .y = v0.y + v1.y }; }
gbVec2 gb_vec2_subi(gbVec2 v0, gbVec2 v1) { return (gbVec2) { .x = v0.x - v1.x, .y = v0.y - v1.y }; }
gbVec2 gb_vec2_muli(gbVec2 v0, float s) { return (gbVec2) { .x = v0.x * s, .y = v0.y * s }; }
...
float gb_vec2_cross(gbVec2 v0, gbVec2 v1) { return v0.x*v1.y - v1.x*v0.y; }
...
gbVec3 gb_vec3_normi(gbVec3 v) {
	gbVec3 r = { 0 }; gb_vec3_norm0(&r, v); return r;
}
...
void gb_mat4_ortho3d(gbMat4 *out, float left, float right, float bottom, float top, float z_near, float z_far) {
	...
	m[3][2] = -(z_far + z_near) / (z_far - z_near) + 0.5f;
#else
...
gbRect2 gb_rect2wh(float x, float y, float w, float h) {
	return (gbRect2) { .pos = { .x = x, .y = y }, .dim = { .x = w, .y = h } };
}
